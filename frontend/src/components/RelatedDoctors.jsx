...
const RelatedDoctors = ({ docId, speciality }) => {
    ...
    // Determine wrapper width class based on count
    const getWidthClass = () => {
        if (relDoc.length === 1) return 'w-1/4'
        if (relDoc.length === 2) return 'w-1/2'
        return 'w-full'
    }
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            ...
            <div className={`${getWidthClass()} grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 pt-5 gap-y-6 px-3 sm:px-0`}>
                {
