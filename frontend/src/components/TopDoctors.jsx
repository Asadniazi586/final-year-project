...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            ...
            <div className={`w-full rounded object-cover grid gap-4 pt-5 gap-y-6 px-3 sm:px-0 ${
                doctors.length === 1 ? "grid-cols-1 max-w-sm mx-auto" :
                doctors.length === 2 ? "grid-cols-2 max-w-lg mx-auto" :
                doctors.length === 3 ? "grid-cols-3 max-w-lg mx-auto" :
